...
Public Class frmSearchProductsales
    ...
    Private Sub DGV1()
        Try
            ...
            frmSales.txtStockID.Text = dr.Cells(0).Value()
            frmSales.txtProductCode.Text = dr.Cells(1).Value()
            frmSales.txtProductName.Text = dr.Cells(2).Value()
            frmSales.txtPacking.Text = dr.Cells(3).Value()
            frmSales.txtTaxPer.Text = dr.Cells(5).Value()
            frmSales.txtAvlUnits.Text = dr.Cells(7).Value()
            frmSales.txtMRP.Text = dr.Cells(6).Value()
            frmSales.txtExp.Text = dr.Cells(8).Value()
            frmSales.txtBatchno.Text = dr.Cells(9).Value()
            If dr.Cells(4).Value() = "GLD" Then
                frmSales.txtLess.Text = "16.49"
            Else
                frmSales.txtLess.Text = "16.66"
            End If
            If frmSales.txtDisc.Text = "" Then
                frmSales.txtDisc.Text = "0"
            End If
            frmSales.txtUnits.Focus()
            frmSales.txtLess_TextChanged(frmOrder.txtLess, EventArgs.Empty)
            Me.Close()
