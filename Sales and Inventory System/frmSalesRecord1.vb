...
Public Class frmSalesRecord1
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            con.Open()
            cmd = New OleDbCommand("SELECT (invoiceNo) as [Invoice No],(BillingDate) as [Invoice Date],(CustomerNo) as [Customer ID],(CustomerName) as [Customer Name],(GrandTotal) as [Grand Total],(TotalPayment) as [Total Payment],(PaymentDue) as [Payment Due], (notes) as [Notes] , (Type) as [Type] from billinfo where BillingDate between #" & dtpInvoiceDateFrom.Value.ToString("MM/dd/yyyy") & "# And #" & dtpInvoiceDateTo.Value.ToString("MM/dd/yyyy") & "# order by BillingDate", con)
    ...
    Private Sub DataGridView1_RowHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DataGridView1.RowHeaderMouseClick
        Try
            ...
            frmSales.dtpTransactionDate.Text = dr.Cells(1).Value.ToString()
            frmSales.txtCustomerNo.Text = dr.Cells(2).Value.ToString()
            ...
            frmSales.txtpayrec.Text = dr.Cells(7).Value.ToString()
            frmSales.cmbInvType.Text = dr.Cells(8).Value.ToString()

            frmSales.ListView1.Items.Clear()

            Dim sSql As String = "SELECT Invoiceno,ProductCode,ProductName,Packing,BillQty,Free,BatchNO,ExpDate,MRP,Rate,Disc,Tax,Amount,StockID from ProductSold  where InvoiceNo = '" & frmSales.txtInvoiceNo.Text & "'"

            FillListView(frmSales.ListView1, frmSales.GetData(sSql))
            frmSales.updatetotal()
    ...
    Private Sub cmbInvoiceNo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbInvoiceNo.SelectedIndexChanged
        Try
            ...
            con.Open()
            cmd = New OleDbCommand(" select (invoiceNo) as [Invoice No],(BillingDate) as [Invoice Date],(CustomerNo) as [Distributor ID],(CustomerName) as [Distributor Name],(GrandTotal) as [Grand Total],(TotalPayment) as [Total Payment],(PaymentDue) as [Payment Due], (notes) as [Notes]  , (Type) as [Type] from billinfo where invoiceno = '" & cmbInvoiceNo.Text & "' order by BillingDate", con)
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        Try
            ...
            con.Open()
            cmd = New OleDbCommand("SELECT (invoiceNo) as [Invoice No],(BillingDate) as [Invoice Date],(CustomerNo) as [Distributor ID],(CustomerName) as [Distributor Name],(GrandTotal) as [Grand Total],(TotalPayment) as [Total Payment],(PaymentDue) as [Payment Due], (notes) as [Notes]  , (Type) as [Type] from billinfo where BillingDate between #" & DateTimePicker2.Value & "# And #" & DateTimePicker1.Value & "# and PaymentDue > 0 order by BillingDate", con)
