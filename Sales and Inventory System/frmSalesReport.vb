...
Public Class frmSalesReport
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            MyCommand.CommandText = "select * from Billinfo where BillingDate between #" & dtpInvoiceDateFrom.Value.ToString("MM/dd/yyyy") & "# And #" & dtpInvoiceDateTo.Value.ToString("MM/dd/yyyy") & "# order by BillingDate"
