...
Public Class rptEstimate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sales_and_Inventory_System.rptEstimate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEstimate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEstimate = New rptEstimate()
        rpt.Site = Me.Site
        Return rpt
    End Function
